...
// MARK: - Request Modifiers
    ...
    /// - Returns: NetworkResourceWithBody
    @objc @discardableResult override func mock(withFile: String, bundle: Bundle = Bundle.main, ofType: String = "json") -> NetworkResourceWithBody {
        super.mock(withFile: withFile, bundle: bundle,  ofType: ofType)
        return self
    }
